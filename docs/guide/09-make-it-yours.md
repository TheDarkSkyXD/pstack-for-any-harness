...
You don't describe your style, because [`/automate-me`](../../.agents/skills/automate-me/SKILL.md) reads it out of the workspace-scoped history exposed by your harness. It mines repeated preferences in replies, delegation, verification, code, prose, and process, then asks which patterns are really you. It drafts `.agents/skills/<your-name>-mode/SKILL.md` through the active harness's skill-authoring guidance, runs the draft through [`/unslop`](../../.agents/skills/unslop/SKILL.md), and opens a PR from a worktree so you review it like any other change.
